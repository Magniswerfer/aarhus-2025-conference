  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Guidelines for authors submitting to the Aarhus 2025 Conference"
        />
      </Head>
      <Layout>
        {/* Hero Section */}
        <div class="bg-aarhus-red py-20">
          <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <p class="text-xl text-white/90 max-w-3xl">
              All submissions are made through the Precision Conference System
              (PCS 2.0). Submissions conflicting with one or more guidelines
              will be removed before or during the reviewing process.
            </p>
          </div>
        </div>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <div class="prose max-w-none">
            ...
            <section class="mb-16">
              ...
              <div class="bg-gray-50 p-6 rounded-lg">
                <p class="mb-4">
                  Submissions that are subject to double-blind peer review must
                  be properly anonymized. Author names and affiliations cannot
                  be disclosed. Make sure that author identities are not
                  accidentally disclosed in file meta-data or by supplementary
                  material.
                </p>
                <p>
                  Aarhus2025 adheres to the CHI anonymization policy; please
                  note that references to previous work by the authors should
                  not be anonymized but referred to in third person. Sometimes
                  this is tricky but in general, do your best to anonymize.
                </p>
              </div>
            </section>
            ...
            <section class="mb-16">
              ...
              <div class="bg-gray-50 p-6 rounded-lg">
                ...
                <p class="mb-4">
                  All references must be complete, accurate, accessible to the
                  public, and conform to the Conference Proceedings Publication
                  Format. Do not cite publications that are proprietary or
                  confidential at the time of publication.
                </p>
                <p>
                  Final camera-ready versions of accepted submissions must be
                  accompanied by a signed copyright form which will be provided
                  to accepted authors.
                </p>
              </div>
            </section>
            ...
            <section class="mb-16">
              ...
              <div class="bg-gray-50 p-6 rounded-lg">
                <p class="mb-4">
                  Final submissions must adhere to ACM's guidelines on
                  accessible PDFs. We recommend working accessibility into your
                  submission sooner rather than later, as accessibility can be
                  an issue also for reviewers.
                </p>
                <p class="mb-4">
                  Visual and audio materials must also be made accessible. For
                  instance, videos must have captions describing both the audio
                  and the visuals.
                </p>
                ...
                <ul class="list-disc ml-6 space-y-2">
                  <li>
                    <a
                      href="http://www.sigaccess.org/welcome-to-sigaccess/resources/accessible-pdf-author-guide/"
                      class="text-aarhus-red hover:text-aarhus-red/80"
                    >
                  ...
                  <li>
                    <a
                      href="https://www.w3.org/WAI/media/av/description/"
                      class="text-aarhus-red hover:text-aarhus-red/80"
                    >
                  ...
                  <li>
                    <a
                      href="https://www.youtube.com/watch?v=F3A1VffiOH4"
                      class="text-aarhus-red hover:text-aarhus-red/80"
                    >
            ...
            <section>
              ...
              <div class="bg-gray-50 p-6 rounded-lg">
                <p class="mb-4">
                  Aarhus2025 adheres to the SIGCHI Policy on Authorship. The use
                  of generative AI tools and technologies to create content is
                  permitted but must be fully disclosed in the work. Generative
                  AI tools and technologies may not be listed as authors.
                </p>
              </div>
            </section>
          </div>
