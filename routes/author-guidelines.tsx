            ...
            <section class="mb-16">
              ...
              <div class="bg-gray-50 p-6 rounded-lg">
                <p class="mb-4">
                  ...
                  where this template is optional (see the <a href="/call-for-contributions" class="text-aarhus-red hover:text-aarhus-red/80">Call for Contributions</a>). Submissions appear in a single-column format
