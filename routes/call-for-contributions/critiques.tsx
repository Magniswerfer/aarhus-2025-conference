...
// Define submission type constant
  ...
  async GET(_req, ctx) {
    try {
      ...
      return ctx.render({
        ...
        description: data.description || "Submit critiques that challenge the status quo of computing.",
      ...
      return ctx.render({
        title: "Critiques",
        description: "Submit critiques that challenge the status quo of computing.",
